...
public:
	...
	// Packet header info
	WORD	   m_nPort;
	IN_ADDR	   m_pSourceAddress;
	IN6_ADDR   m_pSource6Address;
...
public:
	...
	virtual void SmartDumpPort(const SOCKADDR_IN* pAddress, BOOL bUDP, BOOL bOutgoing, DWORD_PTR nNeighbourUnique = 0, WORD nRealPort = 0);
